...
Config.ChairObjects = {
    ...
    {objname = 536071214, offsetX = 0.0 ,offsetY = 0.0 , offsetZ = 0.5, direction = 180},
    {objname = 1451909242, offsetX = 0.0 ,offsetY = 0.0 , offsetZ = 0.5, direction = 180},
    {objname = 784932497, offsetX = 0.0 ,offsetY = 0.0 , offsetZ = 0.125, direction = 180},
    {objname = 1022868206, offsetX = 0.0 ,offsetY = 0.0 , offsetZ = 0.125, direction = 180},
    {objname = 276029927, offsetX = 0.0 ,offsetY = 0.0 , offsetZ = 0.125, direction = 180},
    {objname = -109356459, offsetX = 0.0 ,offsetY = 0.0 , offsetZ = 0.5, direction = 180},
